...
function formatCars(carsJSON) {
  ...
  for(let i = 0, l = carsJSON.length; i < l; i++) {
    resultHtml += `<div class="col-md-4 car"><h2>${carsJSON[i].Make}</h2><p><strong>Model:</strong> ${carsJSON[i].Model}</p><p><strong>Year:</strong> ${carsJSON[i].Year}</p></div>`;
  }
